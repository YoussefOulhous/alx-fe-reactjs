function UserProfile() {
    return (
      ...
      <div className="sm:p-4  bg-gray-100 md:p-8   md:max-w-sm sm:max-w-xs mx-auto my-20 rounded-lg shadow-lg hover:shadow-xl cursor-pointer"> 
        ...
        <img src="https://via.placeholder.com/150" alt="User" className= " sm:w-24 sm:h-24 rounded-full w-24 h-24  md:w-36 md:h-36 mx-auto  hover:scale-110 transition-transform duration-300 ease-in-out" />
